...
for fname in FILES:
    file_check = os.path.join(DIRECTORY, f"{fname}").replace("\\","/")
    ...
    png_img = f'{DIRECTORY}/{mname}'
    img_img = f'{DIRECTORY}/{sname}'
    hdr_img = f'{DIRECTORY}/{hname}'
